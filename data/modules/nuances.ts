...
export const nuances: LearningModule = {
  id: 'nuances',
  title: 'Part 16: Advanced Nuances',
  description: 'Small prepositional shifts that change the entire meaning.',
  icon: '🎭',
  color: 'slate',
  content: `### Small Differences, Big Meanings
Changing a single preposition can completely alter the logic of your sentence.

#### 1. Made Of vs. Made From
- Made Of: Original material is physically recognizable.
- Made From: Material has been transformed.
