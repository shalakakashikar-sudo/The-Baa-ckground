...
export const manner: LearningModule = {
  id: 'manner',
  title: 'Part 9: Manner & Agency',
  description: 'Explaining how things are done and what tools are used.',
  icon: '🛠️',
  color: 'violet',
  content: `### The How of Action
Prepositions of manner explain the method or the agent behind an action.

#### 1. BY (The Agent or Method)
Used for the "doer" in passive sentences and for transport/communication.
...
#### 4. IN (The Style)
Describes the medium or internal quality.
Example: Please write in pencil.
