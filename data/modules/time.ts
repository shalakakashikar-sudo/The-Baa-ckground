...
export const time: LearningModule = {
  id: 'time',
  title: 'Part 5: The Time Timeline',
  description: 'How to use In, On, and At for time.',
  icon: '⏰',
  color: 'amber',
  content: `### The Time Guide
Time uses the same pyramid logic as place. We move from long, general periods down to exact, precise moments.
...
Example: Meet me on Monday.

#### 3. AT (Exact Moments)
Clock times and fixed points.
Example: The barn door opens at 3:00 PM.

#### By vs. Until vs. Before
...
#### During (The Period)
Used to show an action happening throughout a stretch of time.
