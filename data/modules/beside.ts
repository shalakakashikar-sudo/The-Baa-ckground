...
export const beside: LearningModule = {
  id: 'beside',
  title: 'Part 11: Beside vs. Besides',
  description: 'Two similar words with very different meanings.',
  icon: '⚖️',
  color: 'emerald',
  content: `### The Difference an S Makes
One extra letter completely changes the logic of these two words. One is about space; the other is about addition.
...
#### Memory Hook
- Beside: Be + Side (Near).
- Besides: Plus S (Addition).

Example: Besides wool, sheep provide company.`
};